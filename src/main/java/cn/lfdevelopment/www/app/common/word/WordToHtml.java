...
/**
 * Created by LiuFa on 2016/10/15.
 * http://www.cnblogs.com/libaoting/p/wordToMap.html
 */
public class WordToHtml {
    ...
    public static final String inputFile="H:/111222.doc";
    public static final String htmlFile="H:/abc.html";
    ...
    public static String wordImageFilePath(){
        ...
        return  "H:/var/upload/wordImage/word";
    }
    ...
    public static String wordImgeWebPath(){
        ...
        return  "H:/var/e_learning/upload/wordImage/web"+"/";
    }
    ...
    public static void analysisHtmlString(String s){
        ...
        for (int i = 0; i < q.length; i++) {
            if(!"".equals(q[i].toString().replaceAll("</?[^>]+>","").trim())){
        ...
        System.out.println("bigTiMaps的大小："+bigTiMaps.size());
        System.out.println("smalMaps的大小："+smalMaps.size());
        System.out.println("sleMaps的大小："+sleMaps.size());
    }
